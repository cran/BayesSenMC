...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(47, 45, "end", "model_diff");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lub_unconstrain(-(200), 200, Z);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                Z = in__.vector_lub_constrain(-(200), 200, 4, lp__);
            else
                Z = in__.vector_lub_constrain(-(200), 200, 4);
            ...
            check_greater_or_equal(function__, "Se0", Se0, 0);
            check_less_or_equal(function__, "Se0", Se0, 1);
            current_statement_begin__ = 24;
            ...
            check_greater_or_equal(function__, "Se1", Se1, 0);
            check_less_or_equal(function__, "Se1", Se1, 1);
            current_statement_begin__ = 25;
            ...
            check_greater_or_equal(function__, "Sp0", Sp0, 0);
            check_less_or_equal(function__, "Sp0", Sp0, 1);
            current_statement_begin__ = 26;
            ...
            check_greater_or_equal(function__, "Sp1", Sp1, 0);
            check_less_or_equal(function__, "Sp1", Sp1, 1);
            current_statement_begin__ = 27;
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> Z = in__.vector_lub_constrain(-(200), 200, 4);
        size_t Z_j_1_max__ = 4;
        for (size_t j_1__ = 0; j_1__ < Z_j_1_max__; ++j_1__) {
